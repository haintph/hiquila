                ...
                <div class="col-xl-9 col-lg-8">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" value="{{ number_format($dish->price, 0, ',', '.') }} VND" readonly>
                                </div>
                    ...
                    <div class="p-3 bg-light mb-3 rounded">
                        <div class="row justify-content-end g-2">
                            ...
                            <div class="col-lg-2">
                                <a href="{{ route('dish_edit', $dish->id) }}" class="btn btn-outline-secondary w-100">Chỉnh sửa</a>
                            </div>
                        </div>
                    </div>
                </div>
