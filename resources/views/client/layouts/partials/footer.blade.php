            ...
            <div class="col-lg-4 col-md-12 col-sm-7">
                <div class="widgets_container contact_us">
                    <div class="footer_logo">
                        <a href="index.html"><img src="/client/assets/img/logo/logo.png"
                                alt=""></a>
                    </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-5">
                <div class="footer_payment">
                    <ul>
                        <li><a href="#"><img src="/client/assets/img/icon/paypal1.jpg"
                                    alt=""></a></li>
                        <li><a href="#"><img src="/client/assets/img/icon/paypal2.jpg"
                                    alt=""></a></li>
                        <li><a href="#"><img src="/client/assets/img/icon/paypal3.jpg"
                                    alt=""></a></li>
                        <li><a href="#"><img src="/client/assets/img/icon/paypal4.jpg"
                                    alt=""></a></li>
                    </ul>
                </div>
            </div>
