                            ...
                            <figure>
                                <div class="blog_thumb">
                                    <a href="{{ route('post_detail', $post->id) }}">
                                        <img src="{{ asset('storage/' . ($post->image ?? 'client/assets/img/no-image.jpg')) }}" 
                                        alt="{{ $post->title }}">
                                    </a>
                                </div>
                                <figcaption class="blog_content">
                                    <div class="articles_date">
                                        <p>{{ $post->created_at->format('d/m/Y') }} | 
                                            <a href="#">{{ optional($post->category)->name ?? 'Không có danh mục' }}</a>
                                        </p>                         
                                    </div>
                                    <h4 class="post_title">
                                        <a href="{{ route('post_detail', $post->id) }}">{{ $post->title }}</a>
                                    </h4>
                                    <footer class="blog_footer">
                                        <a href="{{ route('post_detail', $post->id) }}">Show more</a>
                                    </footer>
                                </figcaption>
                            </figure>
                        </article>
